...
import { 
  FaBell, FaShieldAlt, FaMapMarkerAlt, FaRobot, FaBook, 
  FaExclamationTriangle, FaBalanceScale, FaQuoteLeft, FaSun, FaMoon, FaFlag 
} from "react-icons/fa";
  ...
  return (
    <div className={`dashboard ${darkMode ? "dark" : "light"}`}>
      ...
      <div className="quick-access">
        <button>
          <FaBell /> Emergency Contacts
        </button>
        <button onClick={() => navigate("/safety-plan")}>
          <FaShieldAlt /> Safety Plan
        </button>
        <button onClick={() => navigate("/resource-locator")}>
          <FaMapMarkerAlt /> Find Clinics and Shelters
        </button>
      </div>
